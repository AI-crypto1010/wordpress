...
class Pix_Eor_Related_Products extends Widget_Base {
	...
	public function get_icon() {
		return 'eicon-related-products pixfort-elementor-element pixfort-elementor-related-products';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pix-related-products h2' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pix-related-products h2',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
					'{{WRAPPER}} .pix-related-products' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		add_filter('woocommerce_output_related_products_args', function($args) use ($settings) {
			$args['posts_per_page'] = $settings['posts_per_page'];
			$args['columns'] = $settings['columns'];
			return $args;
		});

		echo '<div class="pix-related-products">';
