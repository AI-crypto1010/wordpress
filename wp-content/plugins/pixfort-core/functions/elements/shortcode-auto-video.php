    ...
    'params' 		=> array_merge(
        array (
            ...
            array(
                ...
                array(
                    "type" => "checkbox",
                    "heading" => __( "Loop", "pixfort-core" ),
                    "param_name" => "loop",
                    "value" => array( __( "Yes", "pixfort-core" ) => 'loop'),
                    "dependency" => array(
                        "element" => "mp4_video",
                        "not_empty" => true
                    ),
                ...
                array (
                    ...
                    'type' 			=> 'dropdown',
                    'heading' 		=> __('Video Scroll effect', 'pixfort-core'),
                    "description" => __( "Apply effects to the video when scrolling.", "js_composer"),
                    'admin_label'	=> false,
