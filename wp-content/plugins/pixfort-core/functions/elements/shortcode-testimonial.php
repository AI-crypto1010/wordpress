...
$testimonial_params = array_merge (
    array (
...
// Testimonial ----------------------------------------------
vc_map( array (
    'base' 			=> 'pix_testimonial',
    'name' 			=> __('Testimonial', 'pixfort-core'),
    'category' 		=> __('pixfort', 'pixfort-core'),
    "weight"	=> "1000",
    'class'         => 'pixfort_element',
    'icon' 			=> PIX_CORE_PLUGIN_URI . 'functions/images/elements/testimonial.png',
    'description' 	=> __('Add single testimonial element', 'pixfort-core'),
    'params' 		=> array_merge(
