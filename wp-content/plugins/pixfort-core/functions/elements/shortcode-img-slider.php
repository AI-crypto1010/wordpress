...
// pixfort Image slider-----------------------------
vc_map( array (
    'base' 			=> 'pix_img_slider',
    'name' 			=> __('pixfort Image Slider', 'pixfort-core'),
    'category' 		=> __('pixfort', 'pixfort-core'),
    "weight"	=> "1000",
    'class'         => 'pixfort_element',
    'icon' 			=> PIX_CORE_PLUGIN_URI . 'functions/images/elements/image-slider.png',
    'description' 	=> __('Create custom pixfort image slider', 'pixfort-core'),
    'params' 		=> array_merge(
        array (
