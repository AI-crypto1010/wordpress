 ...
 */
class Source_Pixfort extends Source_Base {
	...
	public static function get_template_content( $template_id ) {
		...
		if ( defined('PIXFORT_THEME_SLUG') && PIXFORT_THEME_SLUG === 'acquire') {
			$urlBase = 'https://import.pixfort.com/acquire/elementor/';
		} else if ( defined('PIXFORT_THEME_SLUG') && PIXFORT_THEME_SLUG === 'conseil') {
			$urlBase = 'https://import.pixfort.com/conseil/elementor/';
		} else if ( defined('PIXFORT_THEME_SLUG') && PIXFORT_THEME_SLUG === 'pixfort') {
			$urlBase = 'https://import.pixfort.com/pixfort-theme/elementor/';
		}
