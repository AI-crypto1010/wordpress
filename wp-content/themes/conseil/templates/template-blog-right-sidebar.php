<?php /* Template Name: Blog Sidebar End */
...
?>
<div id="content" class="site-content template-blog-right-sidebar <?php echo esc_html($classes); ?>" style="<?php echo esc_html($styles); ?>" >
    <div class="container">
        <div class="row">
            <?php
            if ($hide_top_area) {
